...
def view():
    ...
    nr=df2.readlines()
    df2.close()
    saved_model = pickle.load(open("C:\\Users\\sanja\\OneDrive\\Desktop\\Project ML\\Classifier_Sentiment_Model.pkl",'rb'))
...
def vectorizer(cleaned_data):
  cvFile='C:\\Users\\sanja\\OneDrive\\Desktop\\Project ML\\bow_sentiment model.pkl'  
